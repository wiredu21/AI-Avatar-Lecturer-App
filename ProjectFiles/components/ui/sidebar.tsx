...
const sidebarVariants = cva("flex flex-col h-screen overflow-hidden transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
    ...
    collapsible: {
      none: "",
      icon: "w-[240px] data-[collapsed=true]:w-[70px]",
      full: "w-[240px] data-[collapsed=true]:w-0",
    },
  },
  defaultVariants: {
    variant: "default",
...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(
  ({ className, variant, collapsible, collapsed = false, ...props }, ref) => {
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute right-2 top-2 h-7 w-7 rounded-md p-1",
          "hover:bg-accent hover:text-accent-foreground",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
          className,
        )}
