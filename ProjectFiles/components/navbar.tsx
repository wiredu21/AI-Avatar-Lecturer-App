  ...
  return (
    <nav
      className={`sticky top-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-[rgba(42,92,141,0.95)] shadow-md" : "bg-transparent"
      }`}
    >
          ...
          <div className="hidden md:flex items-center space-x-4">
            {navItems.map((item) => (
              <ScrollLink
                ...
                smooth={true}
                duration={500}
                className={`px-3 py-2 rounded-md text-sm font-medium cursor-pointer transition-all duration-300 ease-in-out relative group ${
                  isScrolled ? "text-white hover:text-teal-400" : "text-purple-600 hover:text-teal-400"
                }`}
            ...
            <Button
              variant="outline"
              className="text-teal-400 border-teal-400 hover:bg-teal-400 hover:text-white transition-all hover:scale-105"
            >
              Login
            </Button>
            <Button className="bg-gradient-to-r from-teal-400 to-purple-600 text-white hover:from-teal-500 hover:to-purple-700 transition-all hover:scale-105">
              Sign Up
            </Button>
          </div>
        ...
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-blue-900">
            ...
            <div className="mt-4 space-y-2">
              <Button
                variant="outline"
                className="w-full text-teal-400 border-teal-400 hover:bg-teal-400 hover:text-white transition-all"
              >
                Login
              </Button>
              <Button className="w-full bg-gradient-to-r from-teal-400 to-purple-600 text-white hover:from-teal-500 hover:to-purple-700 transition-all">
                Sign Up
              </Button>
            </div>
          </div>
