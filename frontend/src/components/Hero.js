    ...
    return (
        <section id="hero" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-teal-400 to-blue-600">
            ...
            <div className="container mx-auto px-4 py-12 flex flex-col lg:flex-row items-center justify-between">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Meet Your 24/7 AI Lecturer</h1>
                    <p className="text-lg md:text-xl mb-8">Personalising support and guidance for university students</p>
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <Button
                            size="lg"
                            className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-base md:text-lg w-full sm:w-auto"
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="text-white border-white hover:bg-white/20 text-base md:text-lg w-full sm:w-auto"
